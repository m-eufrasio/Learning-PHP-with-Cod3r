<nav class="modulos">
                ...
                <div class="modulo vermelho">
                    <h3>Módulo 02 - Tipagem do PHP</h3>
                    <ul>
                        <li>
                        ...
                        <li>
                            <a href="exercicio.php?dir=tipos&file=conversoes">Conversões PHP</a>
                        </li>
                    </ul>
                </div>
                <div class="modulo azul">
                    ...
                    <ul>
                        <li>
                            <a href="exercicio.php?dir=variáveis&file=basico">Variáveis</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=variáveis&file=desafio_equacao">Desafio Equação</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=variáveis&file=atribuicoes">Atribuições PHP</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=variáveis&file=interpolacao">Interpolação</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=variáveis&file=variaveis_variaveis">Variáveis Variáveis</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=variáveis&file=desafio_variaveis">Desafio Variáveis</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=variáveis&file=valor_referencia">Valor x Referência</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=variáveis&file=constantes">Constantes</a>
                        </li>
                    </ul>
                </div>
                <div class="modulo roxo">
                    ...
                    <ul>
                        <li>
                            <a href="exercicio.php?dir=controle&file=ifelse">If e Else</a>
                        </li>
                        <li>
                ...
                <div class="modulo laranja">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="exercicio.php?dir=array&file=mapa">Mapas</a>
                        </li>
                        <li>
                ...
                <div class="modulo roxo-escuro">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="exercicio.php?dir=includes&file=teste_desafio">Desafio Include/Require</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="modulo ciano">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="exercicio.php?dir=tratamento_erro&file=desafio_intdiv_teste">Desafio intdiv Correção</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=tratamento_erro&file=handler">Error Handler</a>
                        </li>
                    </ul>
                </div>
